...
and get a zip file.  
Unzip it and rename the directory shirriff-Arduino-IRremote-nnn to IRremote
...
************************************************
stripped library by joem to save Arduino memory
when using NEC (Adafruit) remote.
************************************************
Stripped out IR sending to free up Pin 3 for PWM -kgo 
************************************************
